 ...
 *   const { graph, meta } = loadTensionTestWorld();
 */
...
export function loadTensionTestWorld() {
  ...
  return {
    ...
    raw: { nodes: nodesRaw, edges: edgesRaw },
  };
}
