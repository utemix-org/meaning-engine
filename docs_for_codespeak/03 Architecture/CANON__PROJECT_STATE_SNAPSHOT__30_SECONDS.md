...
- Operator boundary: CARD__OPERATOR_VS_EPISTEMIC_ACTION
- Mental model + contracts: OPERATORS_CONTRACTS_AND_CORE_MENTAL_MODEL
- Formula card: CARD__FORMULA_CARD__OPERATORS_AND_CANONICALIZATION
- Kernel boundary checklist: KERNEL_BOUNDARY__WHAT_GOES_IN_AND_WHAT_DOESNT