...
Evidence: [OPUS_TASK__DOC_WORLD__REFERENCE_WORKFLOW__TRACE_COMPARE_BRIDGE__EXPLORATION_ONLY](../12%20Opus%20Value%20Core/OPUS_TASK__DOC_WORLD__REFERENCE_WORKFLOW__TRACE_COMPARE_BRIDGE__EXPLORATION_ONLY.md).
